...
<nav className="animate-in fade-in slide-in-from-top duration-1000  z-9999 mx-1 bg-slate-950/60 backdrop-blur-lg rounded-full overflow-hidden px-2 py-2 border border-white/80 sticky top-2">
  ...
  <span className="text-sm text-bold font-light text-white ml-1.5 align-baseline ">by Anand</span>
</div>
<div className="flex items-center justify-between gap-4 w-full">
  <div className="fixed top-5 right-3 md:right-4 md:top-3 flex items-center gap-2 flex-shrink-0">
    <button 
    ...
    <div className="text-xs mt-8 text-gray-400 mt-03 truncate break-words px-2">
