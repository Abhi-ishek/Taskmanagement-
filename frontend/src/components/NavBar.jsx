...
{
    return(
<nav className="z-9999 mx-1 bg-slate-950/60 backdrop-blur-lg rounded-full overflow-hidden px-2 py-2 border border-white sticky top-2">
  <div className=" px-3 py-2">
    <div className="flex flex justify-center">
         <div className="fixed top-3 left-5 text-white whitespace-nowrap">
  <span className="text-3xl font-extrabold tracking-tight">Tasky</span>
  <span className="text-sm font-light text-white ml-1.5 align-baseline italic">by Anand</span>
</div>
<div className="flex items-center justify-between gap-4 w-full">
  <div className="fixed top-5 right-3 flex items-center gap-2 flex-shrink-0">
    ...
    <div className="text-xs mt-3 text-gray-400 mt-0.5 truncate break-words px-2">
      <GetNewQuote showRefresh={true} style="fixed bottom-2 lg:bottom-8 left-2 sm:left-1/2 sm:-translate-x-1/2 px-1 break-words  text-blue-300 font-semibold rounded-sm break-words" />
    </div>
</div>
