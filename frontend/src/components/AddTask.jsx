...
<div className="fixed top-30 left-0 w-screen z-5 flex items-center justify-center overflow-hidden">
        <form className="rounded-3xl border border-white/400 bg-white/5 p-4 shadow-2xl backdrop-blur-xl transition-all hover:border-white/20 text-gray-500 max-w-87.5 mx-4 md:p-6 text-left text-sm shadow-[0px_0px_10px_0px] shadow-black/10">
        <h3 className="text-xl font-bold mb-2 text-center text-bold text-white">{editingTask? "Edit Task":"Create New Task"}</h3>
        <input 
            className="w-full bg-gray-600  text-amber-50 border my-3 border-gray-500/30 outline-none rounded-full py-2.5 px-4 focus:ring-2 focus:ring-indigo-500/20" 
        ...
        />
        <textarea 
            className="w-full bg-gray-400 border mb-2 text-amber-50 border-gray-500/30 outline-none rounded-3xl py-2 px-2 focus:ring-2 focus:ring-indigo-500/20 resize-none" 
